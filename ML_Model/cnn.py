...
ImgSize = 200
LR = 1e-3
ModelName = 'fireornot-{}-{}.model'.format(LR, '2conv-basic')
...
testerData = np.load('testdata.npy')
...
model.fit({'input': X},{'targets': Y},n_epoch=30, snapshot_step=500, show_metric=True, run_id=ModelName)
model.save((ModelName))
'''
for num,data in enumerate(testerData[:]):
    print(num)
    imgNum = data[1]
    imgData = data[0]
